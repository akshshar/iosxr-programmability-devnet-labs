...
For an onbox client the port forwarding rules do not apply. We can configure gRPC on any port of our choice. We choose port 57777.  
...
## Check that the port is operational
...
<p style="margin: 2em 0!important;padding: 1em;font-family: CiscoSans,Arial,Helvetica,sans-serif;font-size: 1em !important;text-indent: initial;background-color: #eff9ef;border-radius: 5px;box-shadow: 0 1px 1px rgba(0,127,171,0.25);">The service-layer gRPC server is running. Now, let's move on to the client code.  </p>
