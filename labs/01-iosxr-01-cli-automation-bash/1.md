...
<img src="assets/images/anyconnect.png" alt="reserve_button" width="300px"/>
...
<p><u><b>Developer Box (devbox):</b></u></p>


<table>
  <tbody>
    <tr>
      <td style="border: 1px solid lightgray;">**IP**</td>
      <td style="border: 1px solid lightgray;">10.10.20.170 (After VPN connection)</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**SSH Port**</td>
      <td style="border: 1px solid lightgray;">2211</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**Username**</td>
      <td style="border: 1px solid lightgray;">admin</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**Password**</td>
      <td style="border: 1px solid lightgray;">admin</td>
    </tr>
  </tbody>
</table>
...
<p><u><b>IOS-XRv9000 R1:</b></u></p>


<table>
  <tbody>
    <tr>
      <td style="border: 1px solid lightgray;">**Management IP**</td>
      <td style="border: 1px solid lightgray;">10.10.20.170 (After VPN connection)</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**XR SSH Port**</td>
      <td style="border: 1px solid lightgray;">2221</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**NETCONF port**</td>
      <td style="border: 1px solid lightgray;">8321</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**gRPC Port**</td>
      <td style="border: 1px solid lightgray;">57021</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**XR-Bash SSH Port**</td>
      <td style="border: 1px solid lightgray;">2222</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**Username**</td>
      <td style="border: 1px solid lightgray;">admin</td>
...
<table>
  <tbody>
    ...
    <tr>
      <td style="border: 1px solid lightgray;">**XR SSH Port**</td>
      <td style="border: 1px solid lightgray;">2231</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**NETCONF port**</td>
      <td style="border: 1px solid lightgray;">8331</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**gRPC Port**</td>
      <td style="border: 1px solid lightgray;">57031</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**XR-Bash SSH Port**</td>
      <td style="border: 1px solid lightgray;">2232</td>
    </tr>
    <tr>
      <td style="border: 1px solid lightgray;">**Username**</td>
      <td style="border: 1px solid lightgray;">admin</td>
...
**Terminal**:  
If you have a Terminal to work with, along with an SSH client, then to connect to the **devbox**:
<p style="margin: 2em 0!important;padding: 1em;font-family: CiscoSans,Arial,Helvetica,sans-serif;font-size: 1em !important;text-indent: initial;background-color: #e6f2f7;border-radius: 5px;box-shadow: 0 1px 1px rgba(0,127,171,0.25);">**Username**: admin<br/>
**Password**: admin<br/>**SSH port**: 2211
</p>  
...
<p style="margin: 2em 0!important;padding: 1em;font-family: CiscoSans,Arial,Helvetica,sans-serif;font-size: 1em !important;text-indent: initial;background-color: #e6f2f7;border-radius: 5px;box-shadow: 0 1px 1px rgba(0,127,171,0.25);">Connecting to Router r1<br/>**Username**: admin<br/>
**Password**: admin<br/>**SSH port**: 2221
</p>  
