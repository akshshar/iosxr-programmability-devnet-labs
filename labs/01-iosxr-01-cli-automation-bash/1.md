...
<p style="margin: 2em 0 !important;padding: 1em;font-family: CiscoSans,Arial,Helvetica,sans-serif;font-size: 1em !important;text-indent: initial;background-color: #fdefef;border-radius: 5px;box-shadow: 0 1px 1px rgba(0,127,171,0.25);"> You will need to login using one of the suitable options that Devnet URL prompts you with before you can reserve.</p>
...
<img src="assets/images/iosxr-programmability-sandbox-topo.png" alt="reserve_button" width="800px"/>
...
<table>
  <tbody>
    <tr>
      <td>**IP**</td>
      <td>10.10.20.170 (After VPN connection)</td>
    </tr>
    <tr>
      <td>**SSH Port**</td>
      <td>2211</td>
...
![connect_to_devbox](https://media.giphy.com/media/1Ai7JRfd7PL5Iezisa/giphy.gif)
